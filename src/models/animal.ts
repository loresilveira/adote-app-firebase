export interface AnimalModel{
    nome : string;
    pref_moradia: string; // 1-Casa / 2-Apartamento
    pref_porte: string; // 1-pequeno / 2-médio / 3-grande
    pref_pelagem: string; // 1-curta / 2-longa
    pref_sexo: string; // 1- Fêmea / 2- Macho
